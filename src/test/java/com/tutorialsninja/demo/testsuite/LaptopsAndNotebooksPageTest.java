...
public class LaptopsAndNotebooksPageTest extends TestBase {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        //2.20 Fill the mandatory fields
        laptopsAndNotebooksPage.enterTheMandatoryField(laptopsAndNotebooksPage.firstName, "keyur");
        laptopsAndNotebooksPage.enterTheMandatoryField(laptopsAndNotebooksPage.lastName, "patel" );
        laptopsAndNotebooksPage.enterTheMandatoryField(laptopsAndNotebooksPage.eMail, "keyur+123@gmail.com");
        laptopsAndNotebooksPage.enterTheMandatoryField(laptopsAndNotebooksPage.telephone, "07438939393993");
        laptopsAndNotebooksPage.enterTheMandatoryField(laptopsAndNotebooksPage.Address1,"harrow");
        laptopsAndNotebooksPage.enterTheMandatoryField(laptopsAndNotebooksPage.city, "London");
        laptopsAndNotebooksPage.enterTheMandatoryField(laptopsAndNotebooksPage.postcode, "HA9 5AX");
